...
import { PACT_TARGET_PCT } from '@/lib/constants'
    ...
    <div className="min-h-svh pb-28">
      ...
      <div className="flex flex-col items-center mt-6">
        ...
        <p className="font-display text-2xl text-ink mt-1">
          ...
          <span className="text-muted text-base"> / {PACT_TARGET_PCT}%</span>
        </p>
        <p className="text-sm text-muted">
          {progress.combinedEarned} pts of {progress.combinedPossible} · {daysLeft()} days left
        </p>
      </div>
      ...
      <section className="mx-6 mt-8 grid grid-cols-2 gap-3">
        <div className="rounded-card bg-white shadow-sm p-4">
          ...
          <p className="font-display text-3xl text-apeksha mt-2">
            {progress.apekshaPct}%
          </p>
